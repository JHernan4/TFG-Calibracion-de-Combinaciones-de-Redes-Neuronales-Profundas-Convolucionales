...
if __name__ == '__main__':
    ...
    for n in range(nModelos):
        ...
        ECE, MCE, BRIER, NNL = CalculaCalibracion(softmax(logits), test_labels, "RESNET50_modelo_"+str(n+1)+'no_calibrado')
        print("Medidas SIN CALIBRACIÓN para el modelo {}:".format(n+1))
        print("\tECE: {:.2f}%\n\tMCE: {:.2f}%\n\tBRIER: {:.4f}\n\tNLL: {:.4f}".format(100*ECE, 100*MCE, BRIER, NNL))
        ...
        ECE, MCE, BRIER, NNL = CalculaCalibracion(softmax(logitsCal), test_labels, "RESNET50_modelo_"+str(n+1)+'calibrado')
