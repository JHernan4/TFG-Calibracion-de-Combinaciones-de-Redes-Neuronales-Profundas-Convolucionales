...
#para ser posteriormente cargado por el programa ensembleResnet50.py 
##################################################################################################################
...
PATH = './checkpointResnet50/checkpoint'+'_upanets'
np.random.seed(123)
for n in range(5):
    test_loss = 0
    test_list = []
    ...
    plt.savefig(save_path+'/resnet50_train_history_'+str(n+1)+'.png')
    plt.clf()
